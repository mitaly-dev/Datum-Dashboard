    ...
    return (
        <div className='bg-white dark:bg-dark px-8 py-4 sticky top-0 flex justify-between'>
            ...
            <div className='border rounded-lg border-primary'>
                <button className='p-2 bg-[#0c2556] dark:bg-lightDark text-white' onClick={()=>setDark(false)}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 dark:text-white">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
                    </svg>
                </button>
                <button className='p-2 dark:bg-[#0c2556] dark:text-white' onClick={()=>setDark(true)}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 dark:text-white">
